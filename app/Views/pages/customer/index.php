      ...
      <div class="card mb-4">
        <div class="card-header pb-0 d-flex">
          <span class="d-flex justify-content-center align-items-center">
            <h6 class="px-2">Customer List</h6>
          </span>
          <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#add-modal">Add New</button>
        </div>
                ...
                <?php foreach ($customers as $customer => $value): ?>
                  <tr>
                    <td>
                      <div class="d-flex px-2 py-1">
                        <div class="d-flex flex-column justify-content-center">
                          <h6 class="mb-0 text-sm"><?= $value['firstname'].' '.$value['lastname'] ?></h6>
                        </div>
                      </div>
                    </td>
                    <td>
                      <p class="text-xs font-weight-bold mb-0"><?= $value['mobileNumber'] ?></p>
                    </td>
                    <td class="align-middle text-center text-sm">
                      <p class="text-xs font-weight-bold mb-0"><?= $value['city'] ?></p>
                    </td>
                    ...
                    <td class="align-middle">
                      <a href="javascript:;" class="text-secondary font-weight-bold text-xs edit-btn" data-toggle="tooltip" data-original-title="Edit user" data-id="<?= $value['id'] ?>" data-bs-toggle="modal" data-bs-target="#edit-modal">
                        Edit
                      </a>
                    </td>
                  </tr>
